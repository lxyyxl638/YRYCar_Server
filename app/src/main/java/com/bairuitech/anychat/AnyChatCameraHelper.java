...
public class AnyChatCameraHelper implements SurfaceHolder.Callback {
    ...
    public static VideoActivity myActivity = null;
    public void setActivity(VideoActivity activity)
    {
        myActivity = activity;
        System.out.println("已经传入activity");
    }
    // 设置父窗口句柄
    ...
    Camera.PictureCallback myJpegCallback = new Camera.PictureCallback() {
        ...
        public void onPictureTaken(byte[] data, Camera camera) {
            ...
            System.out.println("照了张相，正在传了");
            myActivity.setImage(bm);
